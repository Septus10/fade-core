...
#include <GUI/Gwen.h>
#include <GUI/Skin.h>
#include <GUI/Controls/DockBase.h>
#include <GUI/Controls/DockedTabControl.h>
#include <GUI/Controls/Highlight.h>
#include <GUI/DragAndDrop.h>
#include <GUI/Controls/Resizer.h>
...
void DockBase::RenderOver( Skin::Base* skin )
{
	...
	render->SetDrawColor( Gwen::Color( 255, 0, 0, 20 ) );
	...
	render->SetDrawColor( Gwen::Color( 255, 0, 0, 200 ) );

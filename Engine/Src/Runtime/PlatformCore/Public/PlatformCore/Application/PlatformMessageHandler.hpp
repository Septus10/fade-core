...
{
public:
	virtual bool OnWindowClose(const TSharedPtr<CWindow>& a_Window) { return false; }
	...
	virtual bool OnMouseDown(const TSharedPtr<CWindow>& a_Window, EMouseButton a_Button, Fade::Math::iVec2 a_Location) { return false; }
	virtual bool OnMouseDoubleClick(const TSharedPtr<CWindow>& a_Window, EMouseButton a_Button, Fade::Math::iVec2 a_Location) { return false; }
};
